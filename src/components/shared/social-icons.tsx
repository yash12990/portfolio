...
/**
 * Monochrome brand marks that inherit `currentColor`, so social buttons can be
 * themed like the lucide icons they sit next to (instead of shipping raster
 * PNGs that only stay legible on a white chip).
 */
